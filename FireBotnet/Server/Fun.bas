...
Public Function funflipscreen(bir As Integer)
    ...
    End Select
    thechange = SRCCOPY
    Form4.Picture1.Cls 'Clear picture
    DumpToWindow Form4.Picture1, thechange, fliphorizontal, flipvertical
...
If fliph = True Then Call FlipPictureHorizontal(Form4.Picture1, Form4.Picture1) 'if requested, flip
If flipv = True Then Call FlipPictureVertical(Form4.Picture1, Form4.Picture1) 'if requested, flip
End Sub
